...
- (void)createViews
{
    ...
    [noticeLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.equalTo(indicator.mas_bottom).offset(30);
    ...
    [sudoko mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerX.equalTo(self.view);
        make.top.equalTo(noticeLabel.mas_bottom).with.offset(30);
...
- (void)updateGuiForStep:(JinnLockStep)step
{
    ...
    switch (step)
    {
        case JinnLockStepCreateNew:
        {
            ...
            self.noticeLabel.textColor = JINN_LOCK_COLOR_NOTICENORMAL;
