...
- (void)drawRect:(CGRect)rect
{
    ...
    switch (self.state)
    {
        ...
        case JinnLockCircleStateCenterNormal:
        {
            [self drawCenterCircleWithContext:context
                                         rect:CGRectMake(kCircleWidth / 2,
                                                         ...
                                                         self.diameter - kCircleWidth,
                                                         self.diameter - kCircleWidth)
                                   centerRect:CGRectMake(self.diameter*(0.5- 0.5/kCircleCenterRatio),
                                                         self.diameter*(0.5- 0.5/kCircleCenterRatio),
            ...
            break;
        case JinnLockCircleStateCenterSelected:
        {
            [self drawCenterCircleWithContext:context
                                         rect:CGRectMake(kCircleWidth / 2,
                                                         kCircleWidth / 2,
                                  ...
                                  strokeColor:JINN_LOCK_COLOR_SELECTED
                                    fillColor:JINN_LOCK_COLOR_BACKGROUND];
        }
            break;
        
        case JinnLockCircleStateFillNormal:
        {
            ...
            break;
        case JinnLockCircleStateFillSelected:
        {
            [self drawSolidCircleWithContext:context
                                        rect:CGRectMake(kCircleWidth / 2,
                                                        kCircleWidth / 2,
                          ...
                          fillColor:(UIColor *)fillColor
{
    ...
    if (self.state == JinnLockCircleStateCenterNormal) {
